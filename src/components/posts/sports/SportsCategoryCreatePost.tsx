...
interface SportsCategoryCreatePostProps {
  categoryId?: string;
}

export const SportsCategoryCreatePost = ({ categoryId }: SportsCategoryCreatePostProps) => {
  const { user } = useAuth();
  ...
  return (
    <div className="container max-w-2xl py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold">Create Sports Post</h1>
        <p className="text-muted-foreground">Share your sports insights with the community</p>
      </div>
